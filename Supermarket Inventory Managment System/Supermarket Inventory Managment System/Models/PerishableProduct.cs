...
namespace Supermarket_Inventory_Managment_System.Models
{
    ...
    public sealed class PerishableProduct : Product
    {
        ...
        public PerishableProduct(int productID, string name, double price, int quantity, Category category, string expiryDate, string storageTemp) : base(productID, name, price, quantity, category)
        {
