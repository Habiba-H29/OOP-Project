...
namespace Supermarket_Inventory_Managment_System.Models
{
    ...
    {
        public NonPerishableProduct(int productID, string name, double price, int quantity, Category category, int shelfLifeMonths, string barcode) : base(productID, name, price, quantity, category)
        {
